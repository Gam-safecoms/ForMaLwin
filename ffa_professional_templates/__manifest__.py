# -*- coding: utf-8 -*-
{
    'name': "Faber Flags Professional Report Templates",
    'support': 'support@safecoms.com',
    #'support': 'support@optima.co.ke',

    'summary': """
        Faber Flags Asia Professional Report Templates: Purchase Order, RFQ, Sales Order, Quotation, Invoice, Delivery Note and Picking List""",
