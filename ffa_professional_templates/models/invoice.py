...
class InvoiceTemplates(models.Model):
	...
	def onchange_partner_style(self):
		self.style = self.partner_id.style or self.env.user.company_id.default_style or self.env.ref('ffa_professional_templates.default_style_for_all_reports').id
	...
	def _compute_num2words(self):
		style = self.style or self.partner_id.style or self.env.user.company_id.default_style or self.env.ref('ffa_professional_templates.default_style_for_all_reports').id
